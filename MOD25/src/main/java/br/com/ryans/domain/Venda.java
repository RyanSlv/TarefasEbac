...
public class Venda implements Persistente {
	...
	public void adicionarProdutos(Produto produto, Integer quaantidade ) {
		validarStatus();
	...
	private void validarStatus() {
		if (this.status = Status.CONCLUIDA) {
			throw new UnssuportedOperationException("IMPOSSIVEL ALTERAR VENDA FINALIZADA");
		}
	}
