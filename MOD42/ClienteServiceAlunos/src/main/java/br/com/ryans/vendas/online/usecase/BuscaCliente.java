...
import br.com.ryans.vendas.online.exceptions.EntityNotFoundException;
...
public class BuscaCliente {
	...
	public Cliente buscarPorId(String id) {
        return clienteRepository.findById(id).orElseThrow(() -> new EntityNotFoundException(Cliente.class,"id",id));
	}
